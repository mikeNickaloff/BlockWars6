...
void GameEngine::setMissionForAllBlockQueues(Mission mission)
{
    ...
    emit this->missionAssigned(QVariant::fromValue(this->convertMissionToString(mission)));
...
void GameEngine::startOffense()
{
    ...
    updateGameEngineTimer->start(70);
}
