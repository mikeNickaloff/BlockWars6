    ...
    Column {
        ...
        Rectangle {
            ...
            Text {
                ...
                font.pixelSize: {
                    return Math.min(parent.height * 0.30, parent.width * 0.30)
                }
                anchors.fill: parent
            }
        }
        ...
        Row {
            ...
            ListView {
                ...
                delegate: MainMenuButton {
                    ...
                    text: model.text
                    width: {
                        return powerupMenuListView.width
                    }
                    height: {
                        return powerupMenuListView.height / Math.min(
                                    powerupModel.count, 6)
                    }
                    selected: false
                    Universal.theme: Universal.Dark
                    ...
                    Component.onCompleted: {
                        powerupMenuContainer.selectPowerup.connect(
                                    delegateButton.checkSelectedPowerup)
                        powerupMenuContainer.deselectPowerup.connect(
                                    delegateButton.checkDeSelectedPowerup)
                    }
                }
            }
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        MainMenuButton {
                            ...
                            onMenuButtonClicked: {
                                ...
                                unequipButton.visible = Qt.binding(function () {
                                    return hasPowerup(selectedPowerup)
                                })
                                equipButton.visible = Qt.binding(function () {
                                    return !hasPowerup(selectedPowerup)
                                })
                            }
                            visible: {
                    ...
                    TextArea {
                        ...
                        height: {
                            return parent.height * 0.60
                        }
                        id: descriptionArea
                        font.pixelSize: {
                            return Math.min(parent.height * 0.10,
                                            parent.width * 0.20)
                        }
                        readOnly: true
                    }
